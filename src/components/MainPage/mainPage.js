        ...
        <div className="landing-container">
            ...
            <main className="landing-content">
                ...
                <p>
                    ...
                    Whether you are managing a personal to-do list, team projects, or deadlines, this app has you covered.
                </p>
                <p>
                    You can easily create, edit, and delete tasks, and categorize them based on their priority or deadlines.
